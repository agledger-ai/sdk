...
export class ProjectsResource {
  ...
  create(params: CreateProjectParams, options?: RequestOptions): Promise<Project> {
    return this.http.post<Project>('/v1/projects', params, options);
  }

  /** List projects. */
  list(params?: ListParams, options?: RequestOptions): Promise<Page<Project>> {
  ...
  /** Update a project. */
  update(projectId: string, params: UpdateProjectParams, options?: RequestOptions): Promise<Project> {
